...
public interface ChoiceMapper {
    ...
    @Select("SELECT * from course where id in(SELECT course_id from choice where student_id=#{studentId})"
    )
    List<Course> selectOrderCourseByStudentId(Integer studentId);
}
