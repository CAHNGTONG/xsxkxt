...
public class ChoiceService {
    ...
    public void add(Course course) {
        ...
        List<Course> filerList= CourseTimeUtils.filterAvailableCourses(Arrays.asList(course), courses);
        if (CollectionUtil.isEmpty(filerList)) {
            throw new CustomException("该课程与您目前已选课程有冲突！");
        }
        // 3. 往选课信息表里面插入一条选课记录
