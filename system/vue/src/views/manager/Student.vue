  ...
  <div>
    ...
    <div class="card">
      ...
      <el-table :data="data.tableData" stripe>
        ...
        <!-- 显示专业名称 -->
        <el-table-column label="专业" prop="specialityName"></el-table-column>
    ...
    <el-dialog title="学生信息" width="40%" v-model="data.formVisible" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="data.form" label-width="100px" style="padding-right: 50px">
        ...
        <el-form-item label="所属学院" prop="collegeId">
          <el-select v-model="data.form.collegeId" placeholder="请选择学院" @change="loadSpecialities">
            <el-option
...
const loadSpecialities = () => {
  const collegeId = data.form.collegeId;
  if (collegeId) {
    request.get(`/speciality/selectByCollegeId/${collegeId}`).then(res => {
      if (res.code === '200') {
