<template>
  <div>
    <div style="height: 60px; background-color: #e3e9f3; display: flex; align-items: center; border-bottom: 1px solid #ddd">
      <div style="flex: 1">
        <div style="padding-left: 20px; display: flex; align-items: center">
          <img src="@/assets/imgs/logo.png" alt="" style="width: 65px">
          <div style="font-weight: bold; font-size: 24px; margin-left: 5px">系统</div>
        </div>
      </div>
